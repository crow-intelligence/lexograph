"""The bundled demo text: Chapter 1 of *Pride and Prejudice*.

Jane Austen, *Pride and Prejudice* (1813). Public domain. Transcription from
Project Gutenberg eBook #1342 (https://www.gutenberg.org/ebooks/1342), which is
in the public domain in the United States and most of the world. Only the first
chapter is bundled — a few kilobytes is plenty to drive every preset, and it
keeps the wheel small.

The text lives inline as a module string so it is always importable in doctests
with no package-data or ``importlib.resources`` machinery.
"""

from __future__ import annotations

PRIDE_AND_PREJUDICE_CH1: str = """\
...
to make his wife understand his character.
